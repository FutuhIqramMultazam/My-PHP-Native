...
function upload()
{
    $namaFile = $_FILES['gambar']['name']; // nama file yang kita upload, contoh 'gunung.png'
    $ukuranFile = $_FILES['gambar']['size']; // ukuran penyimpanan gambar
    $error = $_FILES['gambar']['error']; // mengecek error
    $tmpName = $_FILES['gambar']['tmp_name']; // tempat sementara gambar
...
function registrasi($data)
{
    ...
    // cek konfirmasi username suadah ada atau belum 
